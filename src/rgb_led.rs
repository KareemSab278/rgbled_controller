/*
    ...
    DIN is wired to GPIO20 (SPI1 MOSI, physical pin 38) since GPIO10/SPI0 is used elsewhere
    requires dtoverlay=spi1-1cs (or spi1-3cs) enabled in /boot/firmware/config.txt
*/
...
pub fn set_color(color: Color) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let spi = Spi::new(Bus::Spi1, SlaveSelect::Ss0, 3_000_000, Mode::Mode0)?;
